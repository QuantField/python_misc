...
countMissings(data = BiData, graph=True)

transToCategorical(data = BiData, nLevels= 20) # 20 max levels for categorical 
...
#neigh,gnb,qda
models   = [lda,logreg,clf,svm, adab, rmf ] # models neigh,
